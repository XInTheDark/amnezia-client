...
CHAIN_IN="AMN_U2R_AWG_IN"
CHAIN_FWD="AMN_U2R_AWG_FWD"
CHAIN_NAT="AMN_U2R_AWG_NAT"
...
setup_rules() {
  ...
  iptables -t nat -A "$CHAIN_NAT" -s "$AWG_SUBNET_IP/$WIREGUARD_SUBNET_CIDR" ! -o "$UDP2RAW_INTERFACE" -j MASQUERADE
